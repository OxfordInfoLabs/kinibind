// The default `.` adapter that comes with kinibind.js. Allows subscribing to
...
const adapter = {
    ...
    weakReference: function (obj) {
        if (!obj.hasOwnProperty('__kb')) {
            let id = this.counter++

            Object.defineProperty(obj, '__kb', {
                value: id
            })
        }

        if (!this.weakmap[obj.__kb]) {
            this.weakmap[obj.__kb] = {
                callbacks: {}
            }
        }

        return this.weakmap[obj.__kb]
    },
    ...
    unobserveMutations: function (obj, ref, keypath) {
        if ((obj instanceof Array) && (obj.__kb != null)) {
            let map = this.weakmap[obj.__kb]
            ...
            if (map) {
                ...
                if (pointers) {
                    ...
                    this.cleanupWeakReference(map, obj.__kb)
                }
            }
        }
    },
    ...
    observe: function (obj, keypath, callback) {
                    ...
                    set: newValue => {
                        ...
                        if (newValue !== value) {
                            ...
                            if (map) {
                                ...
                                this.observeMutations(newValue, obj.__kb, keypath)
                            }
                        }
                    }
                })
        ...
        this.observeMutations(obj[keypath], obj.__kb, keypath)
    },
            ...
            if (callbacks) {
                ...
                if (idx > -1) {
                    ...
                    if (!callbacks.length) {
                        ...
                        this.unobserveMutations(obj[keypath], obj.__kb, keypath)
                    }
                }
